...
type general struct {
	...
	ICAOAirline       *string `json:"icao_airline"`
	FlightNumber      string  `json:"flight_number"`
	IsEtops           string  `json:"is_etops"`
	DxRmk             string  `json:"dx_rmk"`
	SysRmk            *string `json:"sys_rmk"`
	...
	SidIdent          *string `json:"sid_ident"`
	SidTrans          *string `json:"sid_trans"`
	StarIdent         *string `json:"star_ident"`
	StarTrans         *string `json:"star_trans"`
}
...
type airport struct {
	...
	METARTime       *string `json:"metar_time"`
...
type navlogFix struct {
	...
	FirCrossing *firCrossing `json:"fir_crossing"`
}

type firCrossing struct {
	Fir struct {
		FirIcao      string `json:"fir_icao"`
		FirName      string `json:"fir_name"`
		PosLatEntry  string `json:"pos_lat_entry"`
		PosLongEntry string `json:"pos_long_entry"`
	} `json:"fir"`
}
...
type runway struct {
	...
	IlsFrequency       *string     `json:"ils_frequency"`
	...
	SpeedsOther        *string     `json:"speeds_other"`
	SpeedsOtherId      *string     `json:"speeds_other_id"`
...
type landingRunway struct {
	...
	MaxWeightWet       *string `json:"max_weight_wet"`
}
...
type SimBriefOFP struct {
	...
	TakeoffAltn *string          `json:"takeoff_altn"`
	EnrouteAltn *string          `json:"enroute_altn"`
	Navlog      struct {
	...
	Weather struct {
		...
		ToaltnMETAR *string `json:"toaltn_metar"`
		ToaltnTAF   *string `json:"toaltn_taf"`
		EualtnMETAR *string `json:"eualtn_metar"`
		EualtnTAF   *string `json:"eualtn_taf"`
		EtopsMETAR  *string `json:"etops_metar"`
		EtopsTAF    *string `json:"etops_taf"`
	} `json:"weather"`
	...
	ApiParams        struct {
		...
		Turntoflt      *string `json:"turntoflt"`
		Turntoapt      *string `json:"turntoapt"`
		Turntotime     *string `json:"turntotime"`
		Turnfrflt      *string `json:"turnfrflt"`
		Turnfrapt      *string `json:"turnfrapt"`
		Turnfrtime     *string `json:"turnfrtime"`
		Fuelstats      *string `json:"fuelstats"`
		Contlabel      *string `json:"contlabel"`
		StaticId       *string `json:"static_id"`
		Acdata         *string `json:"acdata"`
